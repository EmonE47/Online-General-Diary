...
// Get notifications
$notifications = getNotifications($currentUser['user_id'], 50);
?>
    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="text-muted mb-0">Stay updated with your assigned cases and system notifications</p>
            </div>
            <div>
                                    ...
                                    <div>
                                        ...
                                        <?php if ($notification['gd_id']): ?>
                                            ...
                                            <small class="text-primary">
                                                ...
                                                Related to GD #<?php echo $notification['gd_id']; ?>
                                            </small>
                                        <?php endif; ?>
                                    </div>
